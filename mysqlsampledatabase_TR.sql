...
*********************************************************************
Name: MySQL Sample Database klasikmodeller
Link: http://www.mysqltutorial.org/mysql-sample-database.aspx
Version 3.1
+ changed data type from DOUBLE to DECIMAL for miktar columns
Version 3.0
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`klasikmodeller` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `musteriler` (
  ...
  `musterSoyAdi` varchar(50) NOT NULL,
  `musterIlkAdi` varchar(50) NOT NULL,
  `telefon` varchar(50) NOT NULL,
  `adresSatiri1` varchar(50) NOT NULL,
  `adresSatiri2` varchar(50) DEFAULT NULL,
  `sehir` varchar(50) NOT NULL,
  `eyalet` varchar(50) DEFAULT NULL,
  `postaKodu` varchar(15) DEFAULT NULL,
  `ulke` varchar(50) NOT NULL,
  `satisTemsPersonelNo` int(11) DEFAULT NULL,
  `krediLimit` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`musteriNo`),
  KEY `satisTemsPersonelNo` (`satisTemsPersonelNo`),
  CONSTRAINT `musteriler_ibfk_1` FOREIGN KEY (`satisTemsPersonelNo`) REFERENCES `personel` (`personelNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `musteriler` */

insert  into `musteriler`(`musteriNo`,`musteriAdi`,`musterSoyAdi`,`musterIlkAdi`,`telefon`,`adresSatiri1`,`adresSatiri2`,`sehir`,`eyalet`,`postaKodu`,`ulke`,`satisTemsPersonelNo`,`krediLimit`) values 
...
(385,'Cruz & Sons Co.','Cruz','Arnold','+63 2 555 3587','15 McCallum Street','NatWest Center #13-03','Makati sehir',NULL,'1227 MM','Philippines',1621,'81500.00'),
...
CREATE TABLE `personel` (
  ...
  `ilkAdi` varchar(50) NOT NULL,
  `extension` varchar(10) NOT NULL,
  `eposta` varchar(100) NOT NULL,
  `ofisKodu` varchar(10) NOT NULL,
  `kimeBagli` int(11) DEFAULT NULL,
  `isTanim` varchar(50) NOT NULL,
  PRIMARY KEY (`personelNo`),
  KEY `kimeBagli` (`kimeBagli`),
  KEY `ofisKodu` (`ofisKodu`),
  CONSTRAINT `personel_ibfk_1` FOREIGN KEY (`kimeBagli`) REFERENCES `personel` (`personelNo`),
  CONSTRAINT `personel_ibfk_2` FOREIGN KEY (`ofisKodu`) REFERENCES `ofisler` (`ofisKodu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `personel` */

insert  into `personel`(`personelNo`,`soyadi`,`ilkAdi`,`extension`,`eposta`,`ofisKodu`,`kimeBagli`,`isTanim`) values 
...
/*Table structure for table `ofisler` */

DROP TABLE IF EXISTS `ofisler`;
...
CREATE TABLE `ofisler` (
  ...
  `eyalet` varchar(50) DEFAULT NULL,
  `ulke` varchar(50) NOT NULL,
  `postaKodu` varchar(15) NOT NULL,
  `bolge` varchar(10) NOT NULL,
  PRIMARY KEY (`ofisKodu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `ofisler` */

insert  into `ofisler`(`ofisKodu`,`sehir`,`telefon`,`adresSatiri1`,`adresSatiri2`,`eyalet`,`ulke`,`postaKodu`,`bolge`) values 
...
CREATE TABLE `siparisDetay` (
  ...
  `urunKodu` varchar(15) NOT NULL,
  `siparisAdet` int(11) NOT NULL,
  `birimFiyat` decimal(10,2) NOT NULL,
  `siparisSatirNo` smallint(6) NOT NULL,
  PRIMARY KEY (`siparisNo`,`urunKodu`),
  KEY `urunKodu` (`urunKodu`),
  CONSTRAINT `siparisDetay_ibfk_1` FOREIGN KEY (`siparisNo`) REFERENCES `siparisler` (`siparisNo`),
  CONSTRAINT `siparisDetay_ibfk_2` FOREIGN KEY (`urunKodu`) REFERENCES `urunler` (`urunKodu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `siparisDetay` */

insert  into `siparisDetay`(`siparisNo`,`urunKodu`,`siparisAdet`,`birimFiyat`,`siparisSatirNo`) values 
...
CREATE TABLE `siparisler` (
  ...
  `istenenTarihi` date NOT NULL,
  `kargoTarihi` date DEFAULT NULL,
  `durum` varchar(15) NOT NULL,
  `yorumlar` text,
  `musteriNo` int(11) NOT NULL,
  PRIMARY KEY (`siparisNo`),
  KEY `musteriNo` (`musteriNo`),
  CONSTRAINT `siparisler_ibfk_1` FOREIGN KEY (`musteriNo`) REFERENCES `musteriler` (`musteriNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `siparisler` */

insert  into `siparisler`(`siparisNo`,`siparisTarihi`,`istenenTarihi`,`kargoTarihi`,`durum`,`yorumlar`,`musteriNo`) values 
...
(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their TESF',216),
...
(10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because musteriler\'s credit limit had been exceeded. Order will ship when payment is received',148),
...
(10173,'2003-11-05','2003-11-15','2003-11-09','Shipped','Cautious optimism. We have happy musteriler here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),
...
(10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their TESF',171),
...
(10260,'2004-06-16','2004-06-22',NULL,'Cancelled','Customer heard complaints from their musteriler and called to cancel this order. Will notify the Sales Manager.',357),
...
(10279,'2004-08-09','2004-08-19','2004-08-15','Shipped','Cautious optimism. We have happy musteriler here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),
...
(10322,'2004-11-04','2004-11-12','2004-11-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their TESF',363),
...
(10377,'2005-02-09','2005-02-21','2005-02-12','Shipped','Cautious optimism. We have happy musteriler here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),
...
CREATE TABLE `odemeler` (
  `musteriNo` int(11) NOT NULL,
  `cekNo` varchar(50) NOT NULL,
  `odemeTarihi` date NOT NULL,
  `miktar` decimal(10,2) NOT NULL,
  PRIMARY KEY (`musteriNo`,`cekNo`),
  CONSTRAINT `odemeler_ibfk_1` FOREIGN KEY (`musteriNo`) REFERENCES `musteriler` (`musteriNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `odemeler` */

insert  into `odemeler`(`musteriNo`,`cekNo`,`odemeTarihi`,`miktar`) values 
...
/*Table structure for table `urunHatlari` */

DROP TABLE IF EXISTS `urunHatlari`;

CREATE TABLE `urunHatlari` (
  `urunHatti` varchar(50) NOT NULL,
  `metinAciklama` varchar(4000) DEFAULT NULL,
  `htmlAciklama` mediumtext,
  `gorsel` mediumblob,
  PRIMARY KEY (`urunHatti`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `urunHatlari` */

insert  into `urunHatlari`(`urunHatti`,`metinAciklama`,`htmlAciklama`,`gorsel`) values 

('Classic Cars','Attention car enthusiasts: Make your wildest car ownership dreams come true. Whether you are looking for classic muscle cars, dream sports cars or movie-inspired miniatures, you will find great choices in this category. These replicas feature superb attention to detail and craftsmanship and offer features such as working steering system, opening forward compartment, opening rear trunk with removable spare wheel, 4-wheel independent spring suspension, and so on. The models range in size from 1:10 to 1:24 scale and include numerous limited edition and several out-of-production vehicles. All models include a certificate of authentisehir from their manufacturers and come fully assembled and ready for display in the home or office.',NULL,NULL),

('Motorcycles','Our motorcycles are eyalet of the art replicas of classic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully assembled and ready for display in the home or office. Most include a certificate of authentisehir.',NULL,NULL),

('Planes','Unique, diecast airplane and helicopter replicas suitable for collections, as well as home, office or classroom decorations. Models contain stunning details such as official logos and insignias, rotating jet engines and propellers, retractable wheels, and so on. Most come fully assembled and with a certificate of authentisehir from their manufacturers.',NULL,NULL),
...
('Trucks and Buses','The Truck and Bus models are realistic replicas of buses and specialized trucks produced from the early 1920s to present. The models range in size from 1:12 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. Materials used include tin, diecast and plastic. All models include a certificate of authentisehir from their manufacturers and are a perfect ornament for the home and office.',NULL,NULL),

('Vintage Cars','Our Vintage Car models realistically portray automobiles produced from the early 1900s through the 1940s. Materials used include Bakelite, diecast, plastic and wood. Most of the replicas are in the 1:18 and 1:24 scale sizes, which provide the optimum in detail and accuracy. Prices range from $30.00 up to $180.00 for some special limited edition replicas. All models include a certificate of authentisehir from their manufacturers and come fully assembled and ready for display in the home or office.',NULL,NULL);
...
CREATE TABLE `urunler` (
  ...
  `urunHatti` varchar(50) NOT NULL,
  `urunOlcek` varchar(10) NOT NULL,
  `urunUretici` varchar(50) NOT NULL,
  `urunAciklama` text NOT NULL,
  `stoktakiMiktar` smallint(6) NOT NULL,
  `alisFiyati` decimal(10,2) NOT NULL,
  `TESF` decimal(10,2) NOT NULL,
  PRIMARY KEY (`urunKodu`),
  KEY `urunHatti` (`urunHatti`),
  CONSTRAINT `urunler_ibfk_1` FOREIGN KEY (`urunHatti`) REFERENCES `urunHatlari` (`urunHatti`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `urunler` */

insert  into `urunler`(`urunKodu`,`urunAdi`,`urunHatti`,`urunOlcek`,`urunUretici`,`urunAciklama`,`stoktakiMiktar`,`alisFiyati`,`TESF`) values 
...
('S10_4698','2003 Harley-Davidson Eagle Drag Bike','Motorcycles','1:10','Red Start Diecast','Model features, official Harley Davidson logos and insignias, detachable rear wheelie bar, heavy diecast metal with resin parts, authentic multi-color tampo-printed graphics, separate engine drive belts, free-turning front fork, rotating tires and rear racing slick, certificate of authentisehir, detailed engine, display stand\r\n, precision diecast replica, baked enamel finish, 1:10 scale model, removable fender, seat and tank cover piece for displaying the superior detail of the v-twin engine',5582,'91.02','193.66'),

('S10_4757','1972 Alfa Romeo GTA','Classic Cars','1:10','Motor sehir Art Classics','Features include: Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',3252,'85.68','136.00'),
...
('S18_1342','1937 Lincoln Berline','Vintage Cars','1:18','Motor sehir Art Classics','Features opening engine cover, doors, trunk, and fuel filler cap. Color black',8693,'60.62','102.74'),
...
('S18_2248','1911 Ford Town Car','Vintage Cars','1:18','Motor sehir Art Classics','Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system.',540,'33.30','60.54'),
...
('S24_1937','1939 Chevrolet Deluxe Coupe','Vintage Cars','1:24','Motor sehir Art Classics','This 1:24 scale die-cast replica of the 1939 Chevrolet Deluxe Coupe has the same classy look as the original. Features opening trunk, hood and doors and a showroom quality baked enamel finish.',7332,'22.57','33.19'),
...
('S24_2022','1938 Cadillac V-16 Presidential Limousine','Vintage Cars','1:24','Classic Metal Creations','This 1:24 scale precision die cast replica of the 1938 Cadillac V-16 Presidential Limousine has all the details of the original, from the flags on the front to an opening back seat compartment complete with teletelefon and rifle. Features factory baked-enamel black finish, hood goddess ornament, working jump seats.',2847,'20.61','44.80'),
...
('S32_1268','1980’s GM Manhattan Express','Trucks and Buses','1:32','Motor sehir Art Classics','This 1980’s era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.',5099,'53.93','96.31'),
...
('S50_1392','Diamond T620 Semi-Skirted Tanker','Trucks and Buses','1:50','Highway 66 Mini Classics','This limited edition model is licensed and perfectly scaled for Lionel Trains. The Diamond T620 has been produced in solid precision diecast and painted with a fire baked enamel finish. It comes with a removable tanker and is a perfect model to add authentisehir to your static train or car layout or to just have on display.',1016,'68.29','115.75'),

('S50_1514','1962 sehir of Detroit Streetcar','Trains','1:50','Classic Metal Creations','This streetcar is a joy to see. It has 99 separate windows, electric wire guides, detailed interiors with seats, poles and drivers controls, rolling and turning wheel assemblies, plus authentic factory baked-enamel finishes (Green Hornet for Chicago and Cream and Crimson for Boston).',1645,'37.49','58.58'),
...
('S700_2466','America West Airlines B757-200','Planes','1:700','Motor sehir Art Classics','Official logos and insignias. Working steering system. Rotating jet engines',9653,'68.80','99.72'),
...
('S700_3167','F/A 18 Hornet 1/72','Planes','1:72','Motor sehir Art Classics','10\" Wingspan with retractable landing gears.Comes with pilot',551,'54.40','80.00'),
...
('S72_1253','Boeing X-32A JSF','Planes','1:72','Motor sehir Art Classics','10\" Wingspan with retractable landing gears.Comes with pilot',4857,'32.77','49.66'),
